...
struct WeightTrendChart: View {
    ...
    private func summaryRow(latest: (date: Date, weight: Double), accent _: Color) -> some View {
    ...
    private func totalChangeBadge(change: Double, sinceDate: Date, accent _: Color) -> some View {
